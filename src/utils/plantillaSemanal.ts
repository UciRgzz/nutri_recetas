...
.page{width:1122px;background:white;border-radius:0;overflow:visible;box-shadow:none;position:relative;margin:0;page-break-after:always;break-after:page;}
...
.infobar{background:linear-gradient(90deg,#2d5a1e,#3d7029,#4a7c3f);padding:4px 24px;display:flex;gap:14px;font-size:9px;color:rgba(255,255,255,.92);letter-spacing:.3px;flex-wrap:wrap;align-items:center;}
...
.mc{border:1px solid #ddeedd;padding:8px 10px;font-size:9px;color:#2c2c2c;vertical-align:top;background:white;min-height:112px;line-height:1.25;cursor:text;overflow:visible;}
...
.ptitle{display:block;font-weight:700;color:#2d5a1e;font-size:9px;margin-bottom:3px;line-height:1.2;}
.ing{display:block;color:#444;font-size:8px;line-height:1.25;}
    ...
    html2pdf().set({
      ...
      html2canvas:{
        ...
        onclone:function(doc){
          ...
          pages.forEach(function(p){p.style.cssText='width:1000px;max-width:1000px;overflow:visible;box-shadow:none;border-radius:0;margin:0 auto;page-break-after:always;';});
        }
      },
