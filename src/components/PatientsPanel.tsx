...
function PatientRow({ patient, expanded, onToggle, onOpenPlan, onUpdated }: {
  ...
  const exportPatientPlan = async () => {
    ...
    const originalWidth = planRoot.style.width;
    const originalMaxWidth = planRoot.style.maxWidth;
    const originalMinWidth = planRoot.style.minWidth;
    ...
    script.onload = () => {
      ...
      const restorePlan = () => {
        ...
        planRoot.style.margin = originalMargin;
        planRoot.style.padding = originalPadding;
      };
